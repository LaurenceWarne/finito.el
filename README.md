...
| `R` | Review the book at point from the current collection                |
| `W` | Toggle display of reviews for the current collection                |
...
| `finito-summary-include-added`                | Include added books in addition to read books in montage images                                    | `t`                                          |
| `finito-show-descriptions-default`            | A flag which controls whether descriptions are shown by default                                    | `t`                                          |
| `finito-show-reviews-default`                 | A flag which controls whether reviews are shown by default                                         | `nil`                                        |
